...
public class ForgotListActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{

    private AppCompatActivity activity = ForgotListActivity.this;
    Context context = ForgotListActivity.this;
    private RecyclerView recyclerViewBeneficiary;
    private ArrayList<Forgot> listBeneficiary;
    private ForgotRecyclerAdapter beneficiaryRecyclerAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot_list);
        this.setTitle("Password Reset Requests");
    ...
    private void initObjects() {
        ...
        beneficiaryRecyclerAdapter = new ForgotRecyclerAdapter(listBeneficiary, this);
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        getMenuInflater().inflate(R.menu.beneficiary_search2, menu);
    ...
    public boolean onQueryTextChange(String newText){
        ...
        ArrayList<Forgot> newList= new ArrayList<>();
        for(Forgot beneficiary: listBeneficiary)
        {
