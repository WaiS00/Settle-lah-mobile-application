...
public class DatabaseHelper1 extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_FAVORITE_TABLE = "CREATE TABLE " + BeneficiaryContract.BeneficiaryEntry.TABLE_NAME + " (" +
                BeneficiaryContract.BeneficiaryEntry._ID + " INTEGER PRIMARY KEY," +
    ...
    //---opens the database---
    public DatabaseHelper1 open() throws SQLException
    {
    ...
    public void removePlace(int position){
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(BeneficiaryContract.BeneficiaryEntry.TABLE_NAME, BeneficiaryContract.BeneficiaryEntry._ID	+ "	= ?", new String[] { String.valueOf(position)});
        db.close();
    }
