...
public class DetailsActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String cityId=getIntent().getStringExtra(com.example.settlelahwaisiong.MyDataAdapter2.ITEM_KEY);
    ...
    private void displayCityData(String cityId) {
        com.example.settlelahwaisiong.CityDataItem2 item= SampleDataProvider2.dataItemMap.get(cityId);
